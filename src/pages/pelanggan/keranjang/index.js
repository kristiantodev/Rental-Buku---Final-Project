...
class Keranjang extends Component {
  ...
  konfirmasiPeminjaman = () => {
    swal({
      title: "Apakah anda yakin ?",
      text: "Setelah anda meminjam, anda harus mengembalikan terlebih dahulu untuk meminjam kembali...",
      icon: "warning",
      buttons: true,
      dangerMode: true,
    }).then((konfirmasi) => {
  ...
  onClickBatalPeminjaman = (id) => {
    swal({
      title: "Apakah anda yakin ?",
      text: "Peminjaman akan dibatalkan dan semua buku dalam keranjang akan dihapus...",
      icon: "warning",
      buttons: true,
      dangerMode: true,
    }).then((konfirmasi) => {
  ...
  checkPengembalian = () => {
    fetch(`http://localhost:8080/api/checkpengembalian/?idUser=${encodeURIComponent(this.props.dataUserLogin.idUser)}`, {
      method: "get",
      headers: {
          "Content-Type": "application/json; ; charset=utf-8",
          "Access-Control-Allow-Headers": "Authorization, Content-Type",
...
<Table className="table dt-responsive nowrap">
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableData rowSpan="3" width="250" align="center">
                    <TextStatus color={this.state.colorText} status={this.state.statusPeminjaman} />
                  </TableData>
                </TableRow>
                <TableRow>
            ...
            <Row>
                ...
                <Table className="table dt-responsive nowrap">
                  ...
                  <TableBody>
                        ...
                        <TableRow key={index}>
                          ...
                          <TableData align="center">
                            <Tooltip keterangan="Hapus Item">
                              <Button className="btn btn-outline-danger" onClick={() => this.onClickDelete(value.idDetail, value.idBuku)}>
                    ...
                    <TableRow>
                      ...
                      <TableData align="center">
                        <Bold>Rp. {this.changeRupiah(this.state.listBuku
                            .map((x) => x.hargaSewa)
              ...
              <Div className="col-lg-3 col-md-6 col-7">
                <Center>
                  <Button className="btn btn-outline-success col-10" onClick={() => this.konfirmasiPeminjaman()}>
                    <Italic className="far fa-check-circle" />
                    &nbsp; Konfirmasi Peminjaman
                  </Button>
                  <Button className="btn btn-outline-danger col-10" onClick={() => this.onClickBatalPeminjaman(this.state.peminjaman.idCart)}>
